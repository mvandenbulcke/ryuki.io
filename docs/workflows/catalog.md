...
- Contract definition `catalog-contract.yaml`
- Serves contract route `/api/catalog/categories`.
- Validator slice `catalog`
- Contract `catalog-contract.yaml` is marked active
