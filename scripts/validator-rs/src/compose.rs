...
const PLATFORM_API_ENVIRONMENT: &[(&str, &str)] = &[
    ...
    (
        "RYUKI_CONFORMANCE_TRUST_ROOT_REGISTRY_PATH",
        "${RYUKI_CONFORMANCE_TRUST_ROOT_REGISTRY_PATH:?required}",
    ),
    (
        "RYUKI_CONFORMANCE_TRUST_ROOT_REGISTRY_DIGEST",
        "${RYUKI_CONFORMANCE_TRUST_ROOT_REGISTRY_DIGEST:?required}",
    ),
    (
        "RYUKI_EXPECTED_DEPLOYMENT_ID",
...
mod tests {
    ...
    fn security_admission_environment_is_exact_and_fail_closed() {
        const SECURITY_ADMISSION_CASES: &[(&str, &str)] = &[
            ...
            (
                "RYUKI_CONFORMANCE_TRUST_ROOT_REGISTRY_PATH",
                "${RYUKI_CONFORMANCE_TRUST_ROOT_REGISTRY_PATH:-unreviewed-registry.json}",
            ),
            (
                "RYUKI_CONFORMANCE_TRUST_ROOT_REGISTRY_DIGEST",
                "${RYUKI_CONFORMANCE_TRUST_ROOT_REGISTRY_DIGEST:-unreviewed-digest}",
            ),
            (
                "RYUKI_EXPECTED_DEPLOYMENT_ID",
