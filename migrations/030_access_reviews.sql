...
INSERT INTO access_reviews (id, target_type, target_name, owner, last_reviewed, next_review_due, status, risk_level, site, reviewer, decision, review_history) VALUES
    ...
    ('c0000200-1000-1000-1000-000000000004', 'FileShare', '\\\\fs01\\finance', 'dave.kim', NOW() - INTERVAL '60 days', NOW() + INTERVAL '5 days', 'UnderReview', 'High', 'GBLON', 'auditor.lee', NULL, ('[{"timestamp": "' || (NOW() - INTERVAL '3 days')::text || '", "action": "initiated", "reviewer": "auditor.lee", "detail": "Review initiated for finance share recertification"}]')::jsonb),
