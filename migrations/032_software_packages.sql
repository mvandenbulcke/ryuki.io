...
INSERT INTO approved_packages (id, name, version, vendor, package_type, approved_by, approved_date, site_scope, site_scope_list) VALUES
    ...
    ('pkg-veeam-agent', 'Veeam Agent for Windows', '6.1.2', 'Veeam Software', 'msi', 'backup-team', '2026-04-10', 'specific', '{"DEFRA","GBLON","NLAMS"}'),
...
INSERT INTO software_deployments (id, server_name, package_id, package_name, target_version, scheduled_time, requester, status, approved_by, executed_at, verified_at) VALUES
    ('dep-001', 'w-defra-srv-01', 'pkg-zabbix-agent', 'Zabbix Agent 7.0', '7.0.4', '2026-06-15 22:00:00Z', 'ops-team', 'Completed', 'admin', '2026-06-14 22:05:00Z', '2026-06-14 22:12:00Z'),
    ('dep-002', 'l-gblon-srv-03', 'pkg-crowdstrike-sensor', 'CrowdStrike Falcon Sensor', '7.11.0', '2026-06-18 23:00:00Z', 'security-team', 'Draft', NULL, NULL, NULL),
    ('dep-003', 'w-nlams-srv-02', 'pkg-qualys-agent', 'Qualys Cloud Agent', '5.2.0', '2026-06-20 01:00:00Z', 'compliance-team', 'Draft', NULL, NULL, NULL);
