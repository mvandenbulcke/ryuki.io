...
INSERT INTO monitoring_review_queue (id, host_or_service_name, review_type, site, assigned_to, sla_deadline, status, created_at) VALUES
    ('d0000100-1000-1000-1000-000000000001', 'srv-defra-web01.corp.local', 'NewOnboarding', 'DEFRA', NULL, NOW() + INTERVAL '48 hours', 'Pending', NOW() - INTERVAL '2 hours'),
    ('d0000100-1000-1000-1000-000000000002', 'srv-gblon-db01.corp.local', 'TemplateMismatch', 'GBLON', 'alice', NOW() - INTERVAL '4 hours', 'Overdue', NOW() - INTERVAL '3 days'),
    ('d0000100-1000-1000-1000-000000000003', 'srv-defra-app02.corp.local', 'GroupChange', 'DEFRA', 'bob', NOW() + INTERVAL '24 hours', 'Assigned', NOW() - INTERVAL '6 hours'),
    ('d0000100-1000-1000-1000-000000000004', 'srv-gblon-fs01.corp.local', 'ProxyReassignment', 'GBLON', 'carol', NOW() + INTERVAL '12 hours', 'InProgress', NOW() - INTERVAL '12 hours'),
    ('d0000100-1000-1000-1000-000000000005', 'srv-nlams-mon01.corp.local', 'DriftDetected', 'NLAMS', NULL, NOW() + INTERVAL '72 hours', 'Pending', NOW() - INTERVAL '1 hour');
