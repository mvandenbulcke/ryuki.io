...
grep -Fqx 'pub const PROTOCOL_VERSION: u32 = 6;' "$PROTOCOL_TYPES" || \
  fail "the proving ground requires the shared protocol-v6 wire contract"
grep -Fqx 'pub const SUPPORTED_PROTOCOL_VERSIONS: &[u32] = &[6];' "$PROTOCOL_TYPES" || \
