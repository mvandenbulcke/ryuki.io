    ...
    match source {
        "vmware" => {
            items.push(InventoryItem {
                ...
                metadata: HashMap::from([
                    ("vcenter".into(), "vcenter-bur1 (simulated)".into()),
                    ("ha_enabled".into(), "true".into()),
                ]),
            });
            items.push(InventoryItem {
                id: "inv-vmware-002".to_string(),
                name: "srv-bur1-web01".into(),
        ...
        "proxmox" => {
            items.push(InventoryItem {
                ...
                name: "proxmox-node-albi-01".into(),
                item_type: InventoryType::HypervisorHost,
        ...
        "cmdb-export" => {
            items.push(InventoryItem {
                ...
                name: "ci-server-bur1-app01".into(),
