...
fn seed_shift_items() -> Vec<ShiftItem> {
    ...
    vec![
        ShiftItem {
            ...
            title: "SQL patching wave failed on sql-defra-01".into(),
        ...
        ShiftItem {
            ...
            description: "Request req-lnx-042 for RHEL deployment at GBLON is blocked. VLAN 210 approval from network team is pending for 6 hours.".into(),
        ...
        ShiftItem {
            ...
            description: "Server srv-legacy-19 at FRPAR is ready for decommission. Quarantine period of 7 days completed. Awaiting infra manager approval.".into(),
            priority: Priority::P3,
        ...
        ShiftItem {
            ...
            title: "Storage latency spike on esx-gblon-02 datastore".into(),
            description: "Active incident: datastore ds-gblon-prod-03 showing 45ms latency (threshold 20ms). 6 VMs affected. Storage team investigating.".into(),
            ...
            metadata: HashMap::from([
                ("site".into(), "GBLON".into()),
                ("datastore".into(), "ds-gblon-prod-03".into()),
        ...
        ShiftItem {
            ...
            title: "Veeam backup job failed for file server fs-nlams-01".into(),
            description: "Last night backup job Backup-FS-NLAMS failed with VSS writer error. No successful backup in 36 hours. Retry attempted 3 times.".into(),
            priority: Priority::P2,
            ...
            metadata: HashMap::from([
                ...
                ("job_name".into(), "Backup-FS-NLAMS".into()),
                ("server".into(), "fs-nlams-01".into()),
            ]),
        },
        ShiftItem {
            id: "shift-006".into(),
...
pub fn get_handover_report() -> Value {
    ...
    json!({
        ...
        "handover_notes": vec![
            ...
            "Veeam failure for fs-nlams-01 is unacknowledged — needs immediate triage",
